...
export function DeleteMedicineDialog({ medicine, open, onOpenChange, onConfirm }: Props) {
  const t = useTranslations('adminMedicines.deleteMedicine');
      ...
      <DialogContent className="w-full max-w-md p-0">
        ...
        <div className="px-6 py-5">
          <p className="text-sm text-[#64748b]">
            {t('message', { name: medicine?.genericName ?? '' })}
          </p>
