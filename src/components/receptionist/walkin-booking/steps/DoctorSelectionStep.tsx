                        ...
                        return (
                            <div
                              ...
                              className={`border-2 rounded-xl p-3 flex items-center gap-3 transition-all ${
                                  isSelected ? 'border-[#1570EF] bg-white ' : 'border-slate-100 bg-white'
                              }`}
                            >
                               ...
                               <div className="flex items-center gap-3">
                                   ...
                                   <button
                                       ...
                                       className={`h-9 px-4 rounded-lg text-sm font-bold transition-colors cursor-pointer ${
                                           isSelected ? 'bg-[#1570EF] text-white' : 'bg-white border border-slate-200 text-slate-700 hover:bg-slate-50'
                                       }`}
                                   >
