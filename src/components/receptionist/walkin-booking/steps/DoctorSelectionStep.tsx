...
import { UserIcon, CheckCircleIcon, MagnifyingGlassIcon, PencilSimpleIcon, CaretLeftIcon, CaretRightIcon, CurrencyCircleDollarIcon, X } from '@phosphor-icons/react';
              ...
              <div className="flex flex-col md:flex-row gap-3">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-10 py-2.5 bg-slate-50 border border-slate-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-[#1570EF]/20 focus:border-[#1570EF] transition-all"
                  />
                  {docSearch && (
                    <button
